...
The configuration script and data for the experiment can be found under `2021_02_24__finite_10k_samples/` in the experiments directory of the git repository. 
