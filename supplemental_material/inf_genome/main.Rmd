...
In an infinite genome, the restraint threshold is set at zero, and thus all non-negative restraint values are restrained. 
...
In this way, the infinite genome always has the same probability of a restraint-reducing mutation as finite genomes have at their restraint threshold.
